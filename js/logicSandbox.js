...
if(  ('user' in url_vars) && ('saveName' in url_vars) ){
	...
	if( ('embed' in url_vars) &&  (url_vars['embed']=='true')){
		...
		$('#editor').hide();
		$('.main').append('<div style="position: relative; bottom: 20px; pointer-events: none; z-index:999"><span id="linkout" style="cursor: pointer; background-color:rgba(200,200,200,0.5); pointer-events: auto; padding: 3px;  font-family:Sans-serif; ">Edit this simulation</span></div>');
